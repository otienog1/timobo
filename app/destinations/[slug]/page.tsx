          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-screen-xl">
            <div className="lg:grid lg:grid-cols-2 lg:gap-20 lg:items-start">
              <div className="mb-12 lg:mb-0">
                ...
                <p className="font-sofia-pro text-sm text-stone-500 leading-relaxed max-w-md">
                  Every season in {destination.name} offers something unique. Let our experts help you choose the perfect time for your journey based on your interests.
                </p>
              </div>

              <div className="space-y-0 divide-y divide-stone-100">
                {parsedBestTime.map(({ period, detail }, index) => (
                  <div key={index} className="flex items-start gap-6 py-7 first:pt-0 last:pb-0">
                    <div className="flex-shrink-0 w-1 self-stretch bg-amber-300/60" />
                    <div>
                      <p className="font-sofia-pro-bold text-sm text-stone-800 mb-1 uppercase tracking-[0.05em]">
                        {period}
                      </p>
                      {detail && (
                        <p className="font-sofia-pro text-sm text-stone-500 leading-relaxed">
